...
Future<void> main() async {
  ...
  //awsait Firebase.initializeApp();
      FirebaseFirestore.instance.collection('Livros').doc("Genero").collection('Contabilidade').doc('Analise didática das demonstrações contábeis').set({'autor': 'desconhecido'});
      ...
      FirebaseFirestore.instance.collection('Livros').doc("Genero").collection('Contabilidade').doc('Matemática financeira').set({'autor': 'desconhecido'});
      ...
      FirebaseFirestore.instance.collection('Livros').doc("Genero").collection('Contabilidade').doc('Contabilidade para os negócios').set({'autor':'desconhecido'});
      ...
      FirebaseFirestore.instance.collection('Livros').doc("Genero").collection('Contabilidade').doc('Contabilidade básica').set({'autor':'desconhecido'});
      FirebaseFirestore.instance.collection('Livros').doc("Genero").collection('Contabilidade').doc('Contabilidade de instituições financeiras').set({'autor':'desconhecido'});
