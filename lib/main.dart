...
Future<void> main() async {
  ...
  //awsait Firebase.initializeApp();
      FirebaseFirestore.instance.collection('Livros').doc("Genero").collection('Marketing').doc('Facebook Marketing').set({'autor': 'desconhecido'});
      FirebaseFirestore.instance.collection('Livros').doc("Genero").collection('Marketing').doc('Transformaão digital').set({'autor':'desconhecido'});
      FirebaseFirestore.instance.collection('Livros').doc("Genero").collection('Marketing').doc('Marketing de Guerrilha Para leigos').set({'autor':'desconhecido'});
      FirebaseFirestore.instance.collection('Livros').doc("Genero").collection('Marketing').doc('Satisfação garantida').set({'autor':'desconhecido'});
      FirebaseFirestore.instance.collection('Livros').doc("Genero").collection('Marketing').doc('Conteúdo S.A').set({'autor':'desconhecido'});
      FirebaseFirestore.instance.collection('Livros').doc("Genero").collection('Marketing').doc('Plataforma a revelação da estratégia').set({'autor':'desconhecido'});
      FirebaseFirestore.instance.collection('Livros').doc("Genero").collection('Marketing').doc('David Aaker abaix os silos').set({'autor':'desconhecido'});
